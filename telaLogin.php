		...
		<div id="contents">
					...
					<div class="entry">
						...
						<table width="377" border="0" align="center">
						  <tr>
						    ...
						    <td width="263"><input name="email" name="text" class="input is-large" placeholder="Seu E-mail" autofocus=""></td>
					      </tr>
						  <tr>
						    <td><h2>Senha:</h2></td>
						    <td><input name="senha" class="input is-large" type="password" placeholder="Sua senha"></td>
					      </tr>
						  <tr>
						    <td>&nbsp;</td>
						    <td>&nbsp;</td>
						  ...
						  <tr>
						    <td>&nbsp;</td>
						    <td><button type="submit" class="button is-block is-link is-large is-fullwidth">Entrar</button>
          <input type= "reset" name = "limpar" value="Limpar" /></td>
						    ...
						    <td>&nbsp;</td>
						  						  ...
						  						  <tr>
						    <td>&nbsp;</td>
						    <td><h3><a href="TelaRecuperaSenha.php"> Recuperar Senha</a></h3></td>
					      </tr>
					  </table>
