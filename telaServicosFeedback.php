...
$consulta = "SELECT 
nome, email, cidade, estado, telefone, sf.servico_oferecido, servico_desejado, es.id_escambo_swop, es.id_servico1, es.id_servico2, es.id_usuario1, es.id_usuario2, es.data_entrega_servico1, es.data_entrega_servico2, es.feedback_servico1, es.nota_servico_prestado, es.nota_usuario, es.feedback_servico2, es.data_cadastro_site 
...
INNER JOIN tb_escambo_swop as es on so.id_usuario = es.id_usuario1";
...
<div id="wrapper">
 ...
 <tr>
							<th>Nº</th>
                                <th>Serviço já Ofertado</th>
								<th>Feedback do Serviço</th>
								<th>Nota do Serviço Ofertado</th>
								<th>Nota do Atendimento Usuário</th>
								<th>Ações</th>								
                        ...
                        <tbody>
							...
							<td><?php echo $dat['id_servico1'] ?></td>
                                ...
                                <td><?php echo $dat['feedback_servico1'] ?></td>
                                <td><?php echo $dat['nota_servico_prestado'] ?></td>
								<td><?php echo $dat['nota_do_usuario'] ?></td>
                                <td></td>
                            </tr>
                            <?php
                                }
