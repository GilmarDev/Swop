...
$consulta = "SELECT nome, email, cidade, estado, telefone, id_servico1, servico_oferecido, categoria_servico_oferecido FROM usuarios as so 

INNER JOIN servico_oferecido as of on so.id_usuario = of.id_usuario WHERE email='".$_SESSION['email']."' AND status_servico_oferecido='1'";
	...
	<div id="menu-wrapper">
		<ul id="menu">
			<li><a href="index.php"><span>Homepage</span></a></li>
					<li class="current_page_item"><a href="telaServicosOferecidos.php"><span>Serviços a Ofertar</span></a></li>
       ...
       <!--  <form id = "" action="cadastrarServicoOferecido.php" method="post">-->
		<form id="formPersonas">  
            <div class="modal-body">
                ...
                <label for="categoria_servico_oferecido" class="col-form-label">Escolha área de atuação:</label>
             				<select class="form-control" name="categoria_servico_oferecido" id="categoria_servico_oferecido">
                ...
                <input type="text" class="form-control" name="servico_oferecido" id="servico_oferecido">
                </div>
